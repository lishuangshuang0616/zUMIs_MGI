...
source(paste0(opt$zUMIs_directory,"/src/statsFUN.R"))
...
if(any(grepl(pattern = "ATTGCGCAATG",x = unlist(opt$sequence_files))) | opt$chemistry == "MGI"){
  print("Counting UMI fragments...")
  script_filepath <- paste0(opt$zUMIs_directory,"/src/misc/countUMIfrags.py")
