...
source(paste0(opt$zUMIs_directory,"/src/runfeatureCountFUN.R"))
source(paste0(opt$zUMIs_directory,"/src/misc/featureCounts.R"))
source(paste0(opt$zUMIs_directory,"/src/UMIstuffFUN.R"))
...
fcounts_clib <- paste0(opt$zUMIs_directory,"/src/misc/fcountsLib2")
